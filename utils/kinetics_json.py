...
def convert_kinetics_csv_to_activitynet_json(train_csv_path, val_csv_path, dst_json_path):
...
if __name__=="__main__":
  ...
  dst_json_path = sys.argv[3]

  convert_kinetics_csv_to_activitynet_json(
    train_csv_path, val_csv_path, dst_json_path)
